...
export const Login = ({ userInitial = "", passwordInitial = "" }: Box) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Note: Keep keys as 'user', 'password', 'balance' 
        // to match your backend logic
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-400 text-sm mt-2">
                        {isLogin ? "Log in to 'Super BANK FAKE' online" : "Join us today"}
                    </p>
                </div>
                ...
                <div className="space-y-4">
                    <div>
                        <label className="block text-slate-400 text-xs uppercase font-semibold mb-2 ml-1">Username</label>
                        <input 
                            type="text" 
                            value={user}
                    ...
                    <div>
                        <label className="block text-slate-400 text-xs uppercase font-semibold mb-2 ml-1">Password</label>
                        <input 
                            type="password" 
                            value={password}
                    ...
                    {!isLogin && (
                        <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                            <label className="block text-slate-400 text-xs uppercase font-semibold mb-2 ml-1">Initial Balance ($)</label>
                            <input 
                                type="number" 
                                value={balance}
